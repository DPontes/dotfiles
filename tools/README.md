...
| `tmux-weather.sh` | Fetches current weather for a city via the Open-Meteo API (5-min cache) | tmux status bar |
...
| `tmux-check-connection.sh` | Prints connection type icon — ethernet, wifi, or offline | tmux status bar |
