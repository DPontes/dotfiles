...
## Key Paths
- `$HOME/dotfiles/tools/tmux-*.sh` - Scripts called by tmux status bar (run frequently, keep fast/fail-safe)
...
## Testing Changes
- Run scripts directly to verify: `/home/s0001483/dotfiles/tools/tmux-vpn.sh`
